...
const MainLayout = () => {
    const [collpseSidebar, setCollapseSidebar] = useState(false)
    return (
        <div className="wrapper " style={{ minHeight: '100vh' }}>
            <nav className={`sidebar ${collpseSidebar ? 'collapsed' : ''}`}>
            ...
            <div className="main">
                ...
                <nav className="navbar">
                    <a className="sidebar-toggle" onClick={() => setCollapseSidebar(!collpseSidebar)}>
                        <i className="hamburger align items-center">
